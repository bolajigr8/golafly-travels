...
import { getCountryPhoto } from '@/lib/esim-countries'
...
// ✅ COUNTRY_PHOTOS removed — now lives in lib/esim-countries.ts
// Re-exported here so any existing import of COUNTRY_PHOTOS from plan-card still works
export { COUNTRY_PHOTOS_BY_CODE as COUNTRY_PHOTOS } from '@/lib/esim-countries'
...
export const PlanCard = memo(function PlanCard({
  ...
  // ✅ now uses central lookup — works for every country
  const photo = getCountryPhoto(pkg.country_code ?? pkg.country)
