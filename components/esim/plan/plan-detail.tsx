...
export function EsimPlanDetail() {
  ...
  // ✅ always returns a photo — no more null/grey box
  const photo = selectedPkg
    ? getCountryPhoto(selectedPkg.country_code ?? selectedPkg.country)
    : getCountryPhoto(countryCodeFromId)
    ...
    <div className='min-h-screen bg-background'>
      <div className='page-container py-6'>
        ...
        >
          <Image
            src={photo}
            alt={selectedPkg?.country ?? destination}
            fill
